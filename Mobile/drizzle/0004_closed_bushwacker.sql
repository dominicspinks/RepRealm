...
CREATE TABLE `__new_categories` (
	...
	`created_at` integer DEFAULT '"2025-02-13T07:04:34.285Z"' NOT NULL,
	`updated_at` integer,
...
CREATE TABLE `__new_exercises` (
	...
	`is_deleted` integer DEFAULT false,
	`created_at` integer DEFAULT '"2025-02-13T07:04:34.286Z"' NOT NULL,
	`updated_at` integer,
...
ALTER TABLE `workout_exercise_sets` DROP COLUMN `reps`;