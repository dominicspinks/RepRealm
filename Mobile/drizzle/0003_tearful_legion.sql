...
CREATE TABLE `__new_categories` (
	...
	`created_at` integer DEFAULT '"2025-02-13T02:57:46.112Z"' NOT NULL,
	`updated_at` integer,
...
CREATE TABLE `__new_exercises` (
	...
	`is_deleted` integer DEFAULT false,
	`created_at` integer DEFAULT '"2025-02-13T02:57:46.113Z"' NOT NULL,
	`updated_at` integer,
...
ALTER TABLE `measurement_units` ADD `decimal_places` integer DEFAULT 0 NOT NULL;